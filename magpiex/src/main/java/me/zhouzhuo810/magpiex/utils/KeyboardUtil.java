...
public final class KeyboardUtil {
    ...
    public static void showSoftInput() {
        InputMethodManager imm = (InputMethodManager) BaseUtil.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
        }
    ...
    private static int getDecorViewInvisibleHeight(@NonNull final Window window) {
        ...
        Log.d("KeyboardBaseUtil", "getDecorViewInvisibleHeight: "
    ...
    public static void clickBlankArea2HideSoftInput() {
        Log.i("KeyboardBaseUtil", "Please refer to the following code.");
        /*
        @Override
        public boolean dispatchTouchEvent(MotionEvent ev) {
            if (ev.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                if (isShouldHideKeyboard(v, ev)) {
                    KeyboardBaseUtil.hideSoftInput(this);
                }
            }
